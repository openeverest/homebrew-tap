class Everestctl < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/openev1.13.0erest/openeverest/releases/download/v1.13.0/everestctl-darwin-amd64"
      sha256 "b1340ad8c1cb67c8cb570943511b3740dc3b5d231510205331ef4d32c990f477"
    elsif Hardware::CPU.arm?
      url "https://github.com/openev1.13.0erest/openeverest/releases/download/v1.13.0/everestctl-darwin-arm64"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/openev1.13.0erest/openeverest/releases/download/v1.13.0/everestctl-linux-amd64"
      sha256 "edd42d88711ba7e66f763f02d72e34b9f765e9253fcf4e4a7ccb85449734a96c"
    elsif Hardware::CPU.arm?
      url "https://github.com/openev1.13.0erest/openeverest/releases/download/v1.13.0/everestctl-linux-arm64"
